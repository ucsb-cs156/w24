...
of these questions (the one that you created in the assignment [{{page.prev_assignment}}]({{page.prev_assignment_link}}).
...
1. (40 pts) For the aspect of software development that you were assigned, the paper describes some aspects of what software development in school is like, vs.
   ...
   In your <tt>{{page.prev_assignment_num}}/sect4.<i>x</i>.md</tt> file (where <tt><i>x</i></tt> is one of 1,2,3,4,5 or 6), 
