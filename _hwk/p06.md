---
layout: default
assigned: 2024-01-16 17:00
description: 'Discuss LTD Paper'
due: 2024-01-16 18:15
title: p06
layout: default
canvas_assignment_link: https://ucsb.instructure.com/courses/17178/assignments/192295
qxx: w24
prev_team_assignment: "[p04](https://ucsb-cs156.github.io/w24/hwk/p04/)"
prev_hwk_assignment: "[h00](https://ucsb-cs156.github.io/w24/hwk/h00/)"
---
...
| Section | Table for all of 4pm and 5pm | Table for all of 6pm and 7pm |
|---------|----------------------------------------------|----------------------------------------|
| 4.1     | 5 | 12 |
| 4.2     | 6 | 13 |
| 4.3     | 7 | 14 |
...
A visual representation of the seating arrangement is here:

![seating arrangement](https://github.com/ucsb-cs156/w24/assets/15284810/0ea1df88-f775-4087-8407-344bf6d4a99c)

If you are on zoom: join the temporary zoom room hosted in the corresponding channel via the `/zoom` command.

If you need extra chairs, feel free to take them from the tables that are not in use. **Please return them when you are done with this activity**.
...
Find the slack channel for your table/group and join it, e.g. `#ltd-4-1-table-5`, `#ltd-4-2-table-6`, etc.  Please note that you will not necessarily see the channel: you'll have to search for it.

Here are the channel names:

<img width="375" alt="image" src="https://github.com/ucsb-cs156/w24/assets/15284810/4cc6bc51-e702-4705-8014-6f6e7b6d5d76">
...
You can quickly host a zoom session in slack by typing `/zoom` in the channel. Use this to join the zoom session for your table and have the scribe share their screen.
...
* The scribe should make a post on the `#help-lecture-discussion` channel to indicate that the group is finished, e.g. <tt>ltd-4-1-table-5 {{page.title}} Step 3 Done!</tt>
...
When the instructor signals, everyone gets up and returns to their original team tables, zoom rooms and slack channels. **If you borrowed chairs, please return them to their original tables.**
...
You may refer to the notes from the `#ltd-4-1-table-5`, `#ltd-4-2-table-6` etc. channels on the slack
...
Put that list on your team's Slack channel (e.g. `w24-5pm-1`, etc.), along with a list of the names of the group members that contributed to your discussion.
