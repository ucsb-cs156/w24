...
| Service                     | Endpoint | 
|-----------------------------|----------|
| `LocationController`       | <https://nominatim.openstreetmap.org/search/Oxnard?format=json> |
| `PublicHolidayQueryService` | <https://date.nager.at/api/v2/publicholidays/2023/us> |
| `TidesQueryService`         | <https://api.tidesandcurrents.noaa.gov/api/prod/datagetter?application=ucsb-cs156&begin_date=20230710&end_date=20230712&station=9411340&product=predictions&datum=mllw&units=english&time_zone=lst_ldt&interval=hilo&format=json> |
| `UniversityQueryService`    | <http://universities.hipolabs.com/search?name=Stanford> |
| `ZipCodeQueryService`       | <http://api.zippopotam.us/us/93106> |
