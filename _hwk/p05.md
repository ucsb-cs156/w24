...
|                                                                      | [m23-10am-4-NOTES](https://github.com/ucsb-cs156-m23/m23-10am-4-NOTES) |
...
<img width="800" alt="notes-repo-click-to-create-README" src="https://github.com/ucsb-cs156/m23/assets/1119017/96683e43-9a19-45f5-9a1d-051236ad4047">
...
Finally, name your file as shown in the example, and fill in content as shown in the example.  For now, we *only* need the heading; the content will come later as part of a homework assignment.
...
* Finish and submit [P04](https://ucsb-cs156.github.io/m23/hwk/p04.html) on Gradescope (before you leave today!)
  - We can't start deploying web apps until everyone completes this.  
* Start on [H00](https://ucsb-cs156.github.io/m23/hwk/h00.html).  
* Work on [jpa00](https://ucsb-cs156.github.io/m23/lab/jpa00.html).
* If when you're done with [jpa00](https://ucsb-cs156.github.io/m23/lab/jpa00.html) on CSIL, consider doing it again on your own machine, including doing all of the [software setup](https://ucsb-cs156.github.io/m23/info/software.html) needed for your machine.
* If you've done [jpa00](https://ucsb-cs156.github.io/m23/lab/jpa00.html) on you own machine, consider doing it again on CSIL to make sure that your CSIL set up is valid (e.g. your `JAVA_HOME` settings and your ssh keys.)
